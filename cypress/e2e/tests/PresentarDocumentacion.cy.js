...
describe(PerDocAportaDocData.testSuites.PresentarDocumentacion, () => {
   ...
   // Obtiene la referencia a la nueva ventana
    ...
    Logger.stepNumber(6);
    Logger.step("Presentar Documento");
    Logger.subStep("Pulsar Presentar");
    PerDocAportaDocMethods.clicOnBotonPresentar();
    Logger.subStep("Muestra pantalla Presentar solicitud");
